...
from google.cloud.client import Translate
import os
os.environ["GOOGLE_APPLICATION_CREDENTIALS"]="/user/orolur/Projects/algolia/agpoc"
...
with open("/user/orolur/Projects/algolia-sr/test/lista10.txt",'r',encoding='utf8') as lista_reci:
    with open("/user/orolur/Projects/algolia-sr/test/nova_lista10.txt", 'w',encoding='utf8') as nova_lista_reci:
